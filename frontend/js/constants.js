...
const welcome_h1 = "The quick brown fox jumps over the lazy dog...";
...
welcome_h1.classList.add('hidden');
welcome_h2.classList.add('hidden');
welcome_p.classList.add('hidden');